...
import com.github.TheGostsniperfr.Arffornia_Launcher.ui.panels.pages.App;
import com.github.TheGostsniperfr.Arffornia_Launcher.ui.panels.pages.Login;
...
public class Launcher extends Application {
    ...
    private final Path launcherDir = GameDirGenerator.createGameDir("Arffornia_V.3", true);
    ...
    public Launcher() {
        ...
        if (!this.launcherDir.toFile().exists()) {
            if (!this.launcherDir.toFile().mkdir()) {
                this.logger.err("Impossible de créer le dossier du lanceur");
            }
        }
